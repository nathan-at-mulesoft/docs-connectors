= Use Anypoint Studio to Configure <Connector-Name> Connector - Mule 4
...
If you are new to configuring connectors in Studio, see xref:connectors::introduction/intro-config-use-studio.adoc[Use Studio to Configure a Connector]. If, after reading this topic, you need additional information about the connector fields, see the xref:connectors-connector-reference.adoc[<Connector-Name> Reference].
...
. In *Add Dependencies to Project*, type `<connector-name>` in the search field.
...
See xref:connectors-connector-config-topics.adoc[Additional Configuration Information] for more configuration steps.
