...
==== Associated Sources
* <<NewRowListener>> {nbsp}
* <<NewOrUpdatedRowListener>> {nbsp}
* <<NewSpreadsheetListener>> {nbsp}
...
Initiates a flow when a row in a specified spreadsheet and worksheet is added into.

==== Parameters
[%header%autowidth.spread]
|===
| Name | Type | Description | Default Value | Required
| Connector configuration | String | Name of the configuration to use. | | x
| Spreadsheet ID | String | ID of the spreadsheet the new row is added into. | | x
| Warksheet Name | String | Name of the sheet the new row is added into. | | x
...
| Reconnection Strategy a| * <<Reconnect>>
* <<ReconnectForever>> |  A retry strategy for connectivity errors. |  |
|===

==== Output
JSON Object with content of the newly added row.

[[NewOrUpdatedRowListener]]
=== On New or Updated Row Listener
`<google-sheets:new-or-updated-row-listener>`
...
| Name | Type | Description | Default Value | Required
| Configuration | String | The name of the configuration to use. | | *x*{nbsp}
| Response timeout a| Number | How long to wait for a response, based on the unit in the Response Timeout field. |  30 | {nbsp}
...
| Spreadsheet ID a| String |  ID of the spreadsheet the new row is added into or updated in. |  | *x*{nbsp}
| Worksheet Name a| String |  Name of the sheet the new row is added into or updated in. |  | *x*{nbsp}
| Reconnection Strategy a| * <<Reconnect>>
* <<ReconnectForever>> |  A retry strategy in case of connectivity errors |  | {nbsp}
|===

==== Output
JSON Object with content of the newly added or updated row.
[%autowidth.spread]
|===
| *Type* a| Any
|===
...
Initiates a flow when a new spreadsheet is created.
...
==== Output
JSON Object containing attributes of the newly created spreadsheet.
[%autowidth.spread]
|===
| *Type* a| Any
|===
