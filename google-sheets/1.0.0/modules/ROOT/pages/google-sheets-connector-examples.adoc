= Google Sheets Connector 1.0.0 Examples - Mule 4
...
* <<create-row,Create a New Row in a Spreadsheet>>
...
[[create-row]]
== Create a Row in a Spreadsheet (Studio Example)
...
== Create a New Row in a Spreadsheet Example
